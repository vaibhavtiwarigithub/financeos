...
export default function PropertyEvidenceImportsWorkspace() {
  ...
  return <PropertyPageFrame eyebrow="Private evidence" title="Tax and insurance evidence" description="Keep an official tax notice or an insurance quote/policy with the property workspace. These records support your own review; Kairos does not extract values or treat a document as an automatic quote.">
