...
export default function SmartMoneyPage({ signals, tradeQueue, highInsider }: {
  signals: any[]; tradeQueue: any[]; highInsider: any[];
}) {
  ...
  useEffect(() => {
    if (tab !== "form4" || edgarFetched || edgarLoading) return;
      ...
      <div style={{ padding: "0 28px 32px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "12px", marginBottom: "20px" }}>
          {([
            ...
            {
              label: "Insider Signals", value: highInsider.length, color: highInsider.length > 0 ? T.green : T.muted, icon: "🏦",
              tip: { title: "Insider Signals", body: "Symbols where the ResearchAgent scored insider_score ≥ 55 in the past 30 days, based on SEC Form 4 filings and Alpha Vantage insider transaction data.", bullets: ["Buy clusters > 3 executives = stronger signal", "Excludes routine stock plan / option exercise buys", "Form 4 tab shows raw SEC EDGAR data"] },
            },
            {
