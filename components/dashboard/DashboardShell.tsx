      ...
      <aside style={{
        ...
        <div style={{ padding: "10px 10px 2px" }}>
          <div style={{ display: "flex", border: `1px solid ${T.border}`, borderRadius: "7px", overflow: "hidden" }}>
            <span style={{ flex: 1, padding: "7px 6px", background: T.accent + "1A", color: T.accent, fontSize: "10px", fontWeight: 700, textAlign: "center" }}>Investing</span>
            <button
              onClick={() => router.push("/property")}
              title="Open the separate property decision workspace"
              style={{ flex: 1, padding: "7px 6px", border: "none", borderLeft: `1px solid ${T.border}`, background: "transparent", color: T.textSub, fontSize: "10px", cursor: "pointer" }}
            >
              Property
            </button>
            <button onClick={() => router.push("/capital-plan")} title="Open cross-workspace Capital Plan" style={{ flex: 1, padding: "7px 6px", border: "none", borderLeft: `1px solid ${T.border}`, background: "transparent", color: T.textSub, fontSize: "10px", cursor: "pointer" }}>Capital</button>
          </div>
        </div>
