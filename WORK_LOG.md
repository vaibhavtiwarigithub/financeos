...
| Research Journal novice-first evidence and context upgrade | Codex / GPT-5 | completed | 2026-07-12 | V2.0 shipped: asset-aware identity, new/recurring/holding history, score/coverage/confidence separation, plain-English action, sector/context links, hype/technical interpretation, downstream-block reasons, and detailed audit layer. US/India browser verified; 305 tests, typecheck and production build green. V2.1 on-demand news and V2.2 point-in-time peers/themes remain architecture-gated follow-ups. |
