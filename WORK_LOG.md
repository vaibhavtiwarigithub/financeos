...
| US/India 10/10 readiness program | Codex / GPT-5 | completed | 2026-07-11 | Added provider exhaustion/stale-cache tests, Robinhood/Kite lifecycle simulations, agentic-account defense, partial-fill mapping, atomic validated champion promotion, market-local live loss boundaries, free-tier EODHD cap, and append-only daily readiness ledger/API/cron. Migrations 161–162 applied; real canary flags remain false pending owner-approved broker tests. |
