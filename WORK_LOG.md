...
| US/India 10/10 readiness program | Codex / GPT-5 | in_progress | 2026-07-11 | Added provider exhaustion/stale-cache tests, Robinhood/Kite lifecycle simulations, agentic-account defense, partial-fill mapping, atomic validated champion promotion, market-local live loss boundaries, free-tier EODHD cap, append-only daily readiness ledger/API/cron, and repaired US shadow evidence generation. Remaining: native INR India shadow sizing/evidence, weekday soak, model artifacts, and owner-approved broker canaries. |
