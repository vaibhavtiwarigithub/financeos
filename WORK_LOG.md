...
| External repository capability catalog + Claude review prompt | Codex / GPT-5 | in_progress | 2026-07-14 | Design-only catalog of every reviewed GitHub candidate: concrete capability, Kairos fit, current coverage, integration boundary, security/license posture, and no-use decisions. No code, migrations, dependencies, credentials, deployment, or execution changes. |
