# Kairos — Agents
> Last updated: 2026-07-22 (ETF analyst_score capped at 65 in ResearchAgent + archetypes; lane-comparison API added; Monte Carlo in BacktestPage; capital-rotation trigger unblocked — see history below)
