...
| `kairos-prewarm-india` | Weekdays every 10 min in the 09:00 UTC hour (before India research) | `POST /api/agents/prewarm?market=india` | Same, India (Yahoo fundamentals + GDELT sentiment). |
