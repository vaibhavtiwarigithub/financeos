...
| `kairos-evidence-cohort-india` | Daily 05:05 UTC (after final India shadow tick) | `POST /api/agents/evidence-cohort?market=india&limit=50` | Same, India/INR. Bar-derived market-session dates prevent weekend/holiday runs from increasing the ten-session cutover count. |
