...
> Last updated: 2026-08-01 (Removed the obsolete `kairos-macro-read-india` cron. India has no domestic macro narrative until the market-local exogenous-risk observation layer has source-backed data; the route continues to refuse India before any LLM call or write.)
