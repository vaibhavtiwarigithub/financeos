# Kairos — Tech Stack
> Last updated: 2026-07-19 (`webull_trade` signed sender restored behind database-backed preflight and nine-gate one-shot permits; adapter and activation remain DISABLED; read-only Cloud MCP remains query-only)
