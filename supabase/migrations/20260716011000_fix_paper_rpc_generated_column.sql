-- Correct the paper autonomy RPCs after discovering that paper_trades.total_value
-- is a GENERATED ALWAYS column. Never name it in INSERT or UPDATE statements.
