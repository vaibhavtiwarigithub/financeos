...
export default async function Page() {
  ...
  const [
    ...
    svc.from("agent_signals").select("symbol,direction,analyst_score,insider_score,technical_score,fundamental_score,sentiment_score,created_at,asset_class,source").gte("created_at", since30).order("analyst_score", { ascending: false }).limit(60),
