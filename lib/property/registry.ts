...
export const PROPERTY_SOURCES: PropertySource[] = [
  ...
  { id: "zillow-zhvi-zip", name: "Zillow Research ZHVI (ZIP)", markets: ["austin", "phoenix"], cadence: "Monthly (polled weekly)", coverage: "ZIP-level typical home value index within the tracked metro", role: "Area context only — a weighted average of the middle third of homes; never a property valuation or AVM", officialUrl: "https://www.zillow.com/research/data/", state: "active" },
