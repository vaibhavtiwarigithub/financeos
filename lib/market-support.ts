...
const REGISTRY: Record<string, MarketSupport> = {
  ...
  "/dashboard/scanner":        { level: "partial",    note: "US full screen; India screens the ~NIFTY-100 universe (no free full-market India screen)." },
  ...
  "/dashboard/smart-money":    { level: "partial",    note: "Signals + trade queue both markets; India insider + options via NSE (US uses EDGAR/options)." },
