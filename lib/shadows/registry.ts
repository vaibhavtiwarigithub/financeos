...
export const SHADOW_PROGRAMS: readonly ShadowProgramDefinition[] = [
  ...
  },
  {
    ...
    category: "Trading",
    markets: ["us", "india"],
    purpose: "Record whether an open position would qualify for a bounded time-stop extension using fresh trend, score, benchmark and event evidence.",
    ...
    evidenceSource: "horizon_extension_shadow",
    ...
    activationGate: "At least 20 independent evaluation dates per market, clean data-quality and event-veto review, matched forward outcomes and owner approval.",
    ...
    callAccounting: "zero_incremental",
    owner: "Trading / Evidence",
    architectureRef: "features/horizon-extension-shadow/FEATURE_ARCHITECTURE.md",
