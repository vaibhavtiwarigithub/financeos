...
export const SHADOW_PROGRAMS: readonly ShadowProgramDefinition[] = [
  ...
  },
  {
    ...
    traderBenefit: "Could avoid losses from deteriorating holdings without selling winners merely because an entry score is no longer high.",
    evidenceSource: "score_exit_shadow_runs",
    currentInfluence: "Measure-only; no score, position monitor, order or broker path reads the results.",
    maximumInfluence: "An owner-approved, market-local score-exit policy after independent evidence and execution-faithful replay.",
    activationGate: "At least 12 effective non-overlapping observations, competing-exit review, cost-aware replay and explicit owner approval.",
    safetyBoundary: "Requires holding_review plus a session-validated is_holding signal; candidate signals fail closed and cannot authorize exits.",
    cronJobs: ["kairos-score-exit-shadow-us", "kairos-score-exit-shadow-india"],
    callAccounting: "zero_incremental",
    owner: "Trading / Evidence",
  ...
  },
  {
    ...
    evidenceSource: "international_allocation_policies + international_allocation_assessments + international_allocation_replay_runs + upgrade_path_attribution_runs",
    ...
    cronJobs: ["kairos-international-allocation-shadow", "kairos-international-allocation-replay-us"],
    callAccounting: "zero_incremental",
